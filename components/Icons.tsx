...
export const BrushIcon: React.FC<IconProps> = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="m9.06 11.9 8.07-8.069a16 16 0 0 0-6.48 14.24c-2.13 2.202-5.75 2.65-7.65 1.48-1.27-.79-1.8-2.36-1.2-3.63.52-1.1 1.4-2.07 2.38-2.76.1-.07.23-.05.31.05l1.4 1.63a2 2 0 0 0 2.62.41l.55-.38a1.99 1.99 0 0 0 .41-2.62l-1.63-1.4a.25.25 0 0 1-.05-.31c.69-.98 1.66-1.86 2.76-2.38 1.27-.6 2.84-.07 3.63 1.2.46.75.61 1.61.46 2.44" />
    <path d="M20.2 6 9 17.2" />
  </svg>
);
...
export const StampIcon: React.FC<IconProps> = (props) => (
  ...
  >
    <path d="M16 10 2 22" />
    <path d="m2 6 4.13 4.13a2 2 0 0 1 .46 1.88L5.8 16.8a2 2 0 0 0 .59 2.14l.54.54a2 2 0 0 0 2.14.59l4.79-.79a2 2 0 0 1 1.88.46L22 22" />
    <path d="M20 2a2 2 0 1 0-4 0l-1.5 1.5a2 2 0 0 0 0 2.83l1.17 1.17a2 2 0 0 0 2.83 0L20 6a2 2 0 1 0 0-4Z" />
  </svg>
);
...
export const ScanEyeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const LightbulbIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-1 1.5-2 1.5-3.5 0-3-2.5-5-5-5s-5 2-5 5c0 1.5.5 2.5 1.5 3.5.8.8 1.3 1.5 1.5 2.5" />
    <path d="M9 18h6" />
    <path d="M10 22h4" />
  </svg>
);
